import { CommandInteraction, GuildMember, MessageEmbed, Role, User } from "discord.js";

import {incrementUserPoints, getUserPoints} from "./db/db";

export async function displayErrorMessage(interaction: CommandInteraction, description: string) {
